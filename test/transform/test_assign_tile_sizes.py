...
# Exercises the strategy named attribute wiring through the op's apply() method.
# Builds a schedule that inspects the strategy field on the IR op directly and
# also verifies the resulting tile sizes are driven by the strategy value.
...
def run(name: str, strategy: str):
    ...
    with ir.Context(), ir.Location.unknown():
        ...
        with schedule_boilerplate() as (sched, named_seq):
            ...
            annotated_handle = assign_tile_sizes(ops, strategy=strategy)
